...
/*############################################################*/
document.getElementById('thumbnail_1').addEventListener('click', function() {
    // URL do vídeo do YouTube. Substitua pelo seu próprio URL do vídeo
    var videoUrl = 'https://www.youtube.com/embed/1bfJ0ZjGWoU?autoplay=1';
    
    // Substitua VIDEO_ID pelo ID real do seu vídeo do YouTube
    var iframe = document.getElementById('youtube_video_1');
    iframe.src = videoUrl;
    iframe.style.display = 'block';

    // Ocultar a miniatura e o botão de play
    document.getElementById('thumbnail_1').style.display = 'none';
    document.getElementById('botao_play_1').style.display = 'none';
});

document.getElementById('thumbnail_2').addEventListener('click', function() {
    // URL do vídeo do YouTube. Substitua pelo seu próprio URL do vídeo
    var videoUrl = 'https://www.youtube.com/embed/KgInN9UhOA0?autoplay=1';
    
    // Substitua VIDEO_ID pelo ID real do seu vídeo do YouTube
    var iframe = document.getElementById('youtube_video_2');
    iframe.src = videoUrl;
    iframe.style.display = 'block';

    // Ocultar a miniatura e o botão de play
    document.getElementById('thumbnail_2').style.display = 'none';
    document.getElementById('botao_play_2').style.display = 'none';
});
/*############################################################*/
