...
const obj_bt_delves_dot = document.querySelector('#bt_delves_dot');
const obj_bt_warbands_dot = document.querySelector('#bt_warbands_dot');
const obj_bt_talents_dot = document.querySelector('#bt_talents_dot');
const obj_bt_earthen_dot = document.querySelector('#bt_earthen_dot');
const obj_bt_flying_dot = document.querySelector('#bt_flying_dot');
const obj_bt_dungeons_dot = document.querySelector('#bt_dungeons_dot');
...
obj_bt_delves_dot.addEventListener('click', funAtivaDelves);
obj_bt_warbands_dot.addEventListener('click', funAtivaWarbands);
obj_bt_talents_dot.addEventListener('click', funAtivaTalents);
obj_bt_earthen_dot.addEventListener('click', funAtivaEarthen);
obj_bt_flying_dot.addEventListener('click', funAtivaFlying);
obj_bt_dungeons_dot.addEventListener('click', funAtivaDungeons);
